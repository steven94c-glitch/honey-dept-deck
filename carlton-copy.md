# Honey Department — Copy Doc

Edit anything inside the **▼ EDIT** / **▲ END** markers. Keep the headers and labels as-is so the deck knows where each piece goes. When you're ready for a new draft to go live, send the whole doc back to Steve.

---

## 01 · HELLO  (intro page after the cover)

**Section tag (small pill at top):**
▼ EDIT
01 · Hello
▲ END
...
**Section tag (small pill on the body page):**
▼ EDIT
02 · The Tone
▲ END
...
**Right column — bullet list (one item per line):**
▼ EDIT
Observational, never satirical
Deadpan tempo over comic timing
Specificity beats scale every time
Honey is present, never celebrated
Real people when we can find them
Real environments, real light
Wide before close. Always.
The cut should arrive late
▲ END
...
**Left column body:**
▼ EDIT
All four films share a cutting rhythm. We hold each shot one beat past comfort. The longer we trust the frame, the funnier it gets. Tati's rule — if you cut on the laugh, you killed the laugh.
...
**Right column subhead 3 (Voiceover):**
▼ EDIT
Voiceover
▲ END
...
**Small credit underneath:**
▼ EDIT
Honey Department · Fall 2026
▲ END
